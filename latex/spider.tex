...
\tkzKiviatDiagram[label distance=4cm,
 radial = 20,
 gap = 0.85, 
 lattice = 9]{Flesch-Kincaid, Gunning fog, SMOG, Coleman-Liau, ARI}
...
\tkzKiviatLine[ultra thick,color=red, fill=black!20,opacity=.5](3.874,6.874,7.417,8.157,3.507) 
...
\node[draw=none, color=red, font=\Large] at (-1.5,4) {Trump};
\node[draw=none, color=blue, font=\Large] at (5,4) {Clinton};
\end{tikzpicture}
