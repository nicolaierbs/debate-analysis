...
\title{2020 Presidential Debates}
\date{\today}
...
\tkzKiviatDiagram[label distance=4cm,
 radial = 16,
 gap = 0.80, 
 lattice = 8]{Flesch-Kincaid, Gunning fog, SMOG, Coleman-Liau, ARI}
...
%{flesch=89.85288322638065, smog=7.06700633642739, ari=2.4223775118272535, lix=0.0, coleman_liau=8.17735557481225, kincaid=3.0511339797336348, fog=6.099721766827487}
 
\tkzKiviatLine[ultra thick,color=red, fill=black!20,opacity=.5](3.051, 6.100, 7.067, 8.177, 2.422) 
\tkzKiviatLine[thick, color=red, fill=black!20,opacity=.1](3.813,6.689,7.344,8.342,3.380) 
...
%{flesch=87.65084581190054, smog=7.516858427076419, ari=2.99982601548912, lix=0.0, coleman_liau=8.19043733035286, kincaid=3.63999876437914, fog=6.7893214542562195}
\tkzKiviatLine[ultra thick,color=blue,mark=none, fill=blue!20,opacity=.5](3.640, 6.789, 7.517, 8.190, 3.000)
\tkzKiviatLine[thick, color=blue,mark=none, fill=blue!20,opacity=.1](6.186,9.423,9.127,9.123,6.233)
...
\node[draw=none, color=red, font=\Large] at (-1.5,3.2) {Trump 2020};
\node[draw=none, color=blue, font=\Large] at (-1.5,5.0) {Biden 2020};
\node[draw=none, color=red, font=\small] at (-1.5,-3.7) {Trump 2016};
\node[draw=none, color=blue, font=\small] at (-1.5,-5) {Clinton 2016};
\end{tikzpicture}

\caption{Profil der Texte.}
